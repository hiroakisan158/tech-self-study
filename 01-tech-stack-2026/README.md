...
4. 各教材の language-overview([TS](../04-typescript-fable-101/language-overview/README.md) /
   [React](../05-react-fable-101/language-overview/README.md) /
   [Next.js](../06-nextjs-fable-101/language-overview/README.md) /
   [Go](../03-go-fable-101/language-overview/README.md) /
   [Python](../02-python-fable-101/language-overview/README.md))と往復すると、
