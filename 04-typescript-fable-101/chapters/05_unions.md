...
>
> 多くの言語は選択肢を **列挙型(enum)** で表します([Go は `iota` による擬似 enum](../../03-go-fable-101/chapters/01_variables.md)、
...
> います](../../03-go-fable-101/language-overview/README.md)。2010 年代の言語(Swift, Kotlin, Rust)は
...
書き忘れた分岐を全部教えてくれます**。[Go の擬似 enum に欠けている網羅性検査](../../03-go-fable-101/language-overview/README.md)を、TS は型システムで実現しているわけです。
