...
>
> 実はこれ、[Go の interface](../../go-fable-101/chapters/09_interfaces.md)(`implements` 不要で
> メソッドがあれば満たす)と同じ思想で、[Python の duck typing](../../python-fable-101/chapters/09_dunder.md)
