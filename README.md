...
| 教材 | 題材 | 学ぶもの | 位置づけ |
|---|---|---|---|
| [python-fable-101](python-fable-101/README.md) | 🧪 魔法薬店「Pythonic Potions」 | Python 基礎〜上級(メタクラスまで) | 独立(単体で完結) |
| [go-fable-101](go-fable-101/README.md) | 🚇 運送会社「Gopher Express」 | Go 基礎〜並行処理・テスト | 独立(単体で完結) |
...
- React 教材から始めたくなったら → まず [TS 教材の第 3・4・9・10・12 章](typescript-fable-101/README.md)だけでも先に
...
- [Python](python-fable-101/language-overview/README.md) — 「人間の時間」に最適化
- [Go](go-fable-101/language-overview/README.md) — 「チームと機械の時間」に最適化
- [TypeScript](typescript-fable-101/language-overview/README.md) — 「JS と共存する現実」に最適化
- [React](react-fable-101/language-overview/README.md) — 「UI の状態管理」に最適化
- [Next.js](nextjs-fable-101/language-overview/README.md) — 「配信までの時間と開発速度」に最適化
...
3. **1 日 1 章ペースが目安。** 16 章 × 5 教材 = 約 3〜4 か月で全課程(Web 3 部作だけなら約 2 か月)
