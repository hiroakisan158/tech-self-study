...
[型の保証がない世界](../../04-typescript-fable-101/chapters/14_runtime_validation.md)——と接続します。
...
[第 5 章の教え](../../04-typescript-fable-101/chapters/05_unions.md)に従い、
...
> [2 羽のフクロウが同時に飛んでいて](../../04-typescript-fable-101/chapters/11_event_loop.md)、
...
> [クロージャ](../../04-typescript-fable-101/chapters/09_array_methods.md)が世代ごとの `ignore` を
...
[as は検査ではなく検査の免除](../../04-typescript-fable-101/chapters/13_advanced_types.md)でした。
新聞社の API が仕様変更で `stars` を文字列にしたら、型は通ったまま実行時に画面が壊れます。
[TS 第 14 章の門番](../../04-typescript-fable-101/chapters/14_runtime_validation.md)を立てましょう:
