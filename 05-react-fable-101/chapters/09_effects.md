...
つまり [`setInterval`](../../04-typescript-fable-101/chapters/11_event_loop.md) が必要です。
...
**[純粋](../../04-typescript-fable-101/chapters/16_final.md)** であるべし——同じ props/state なら
...
[イベントループ上で永遠に鳴り続けます](../../04-typescript-fable-101/chapters/11_event_loop.md)。
タイマー、購読、接続……**始めたものは返す関数で必ず終わらせる**。
[Python の `with`](../../02-python-fable-101/chapters/12_context_managers.md) や
[Go の `defer`](../../03-go-fable-101/chapters/03_functions.md) と同じ「後始末の規律」です。
...
> 「古い値を見続ける」バグ(stale closure — [クロージャ](../../04-typescript-fable-101/chapters/09_array_methods.md)が
