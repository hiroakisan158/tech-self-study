...
[TS 第 5 章で学んだ判別可能 union](../../04-typescript-fable-101/chapters/05_unions.md) そのものです。
...
[第 5 章のクエスト状態機械](../../04-typescript-fable-101/chapters/05_unions.md)で関数が守っていた
...
> ([TS 第 9 章](../../04-typescript-fable-101/chapters/09_array_methods.md)——「積み重なった
...
台本は騙せません。[城壁と門番](../../04-typescript-fable-101/chapters/14_runtime_validation.md)の
発想と同じ多層防御です。
...
[TS 第 12 章の async/await](../../04-typescript-fable-101/chapters/12_async_await.md) と
[第 14 章の門番](../../04-typescript-fable-101/chapters/14_runtime_validation.md)を React に接続します。
