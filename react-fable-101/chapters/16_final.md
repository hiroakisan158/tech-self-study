...
[TS 第 16 章](../../typescript-fable-101/chapters/16_final.md)で「型が形を守り、テストが
...
| 道具 | 役割 |
|---|---|
| **Vitest** | テストランナー([TS 第 16 章](../../typescript-fable-101/chapters/16_final.md)と同じ) |
...
3. わざと `theaterReducer` の遷移ガードを 1 つ消して、テストが赤くなることを確認してください([赤を見るのも卒業体験](../../typescript-fable-101/chapters/16_final.md)です)。
