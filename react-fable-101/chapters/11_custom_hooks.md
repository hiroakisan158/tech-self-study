...
ロジックなら[関数に切り出す](../../typescript-fable-101/chapters/04_functions.md)のが常道——
...
[構造的型付け](../../typescript-fable-101/chapters/03_objects_arrays.md)の精神です。
`as const` は[タプルとして推論させるための一手](../../typescript-fable-101/chapters/13_advanced_types.md)です
...
> [npm に公開する](../../typescript-fable-101/chapters/15_build_ecosystem.md)のも簡単です。
>
