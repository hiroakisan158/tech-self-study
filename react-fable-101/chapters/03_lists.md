...
[TypeScript 第 9 章で習得済み](../../typescript-fable-101/chapters/09_array_methods.md)の
...
> ```
>
> `reservedCount` が `0` のとき、[0 は falsy](../../typescript-fable-101/chapters/02_numbers_strings.md)
...
2. 「開演時間順(昇順)の看板」を追加してください。[`toSorted`](../../typescript-fable-101/chapters/09_array_methods.md) を使い、元の配列を壊さないこと。
3. `GENRE_LABEL` の仕組みを説明してください。`Record<Show["genre"], string>` の `Show["genre"]` は何型でしょう?([TS 第 13 章の indexed access](../../typescript-fable-101/chapters/13_advanced_types.md) の復習)
