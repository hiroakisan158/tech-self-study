...
その前に、[TS 第 15 章で `tsc` の出力(dist/)を解剖した](../../04-typescript-fable-101/chapters/15_build_ecosystem.md)ように、
...
1. **翻訳と束ね** — TS → JS の翻訳([1F の知識](../../04-typescript-fable-101/chapters/15_build_ecosystem.md))、
...
> という不信(react overview 6.5)](../../05-react-fable-101/language-overview/README.md)も生みました。
...
自己完結フォルダを作る設定です。[Go の「単一バイナリ」](../../03-go-fable-101/language-overview/README.md)ほどの
