...
- **HTTP メソッド名の関数を export** します: `GET`、`POST`、`PUT`、`DELETE`…。
  [TS 教材でフクロウ便を await した](../../04-typescript-fable-101/chapters/12_async_await.md)のと同じ
...
[城壁の外](../../04-typescript-fable-101/chapters/14_runtime_validation.md)** ——門番(zod)は
...
[Go 教材で HTTP サーバーを書いた人](../../03-go-fable-101/chapters/14_http_json.md)には
