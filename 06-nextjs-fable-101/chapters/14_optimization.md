...
([コンポーネントの中ではない](../../05-react-fable-101/chapters/05_state.md))。これは
...
([「データと画面の一致」](../../05-react-fable-101/chapters/03_lists.md)が SEO にまで貫通)。
...
>
> そしてこれが、[React 単体(CSR)ではなくフレームワークが推奨される](../../05-react-fable-101/language-overview/README.md)
...
[React 第 15 章の「まず測る」](../../05-react-fable-101/chapters/15_performance.md)と同じ規律です
