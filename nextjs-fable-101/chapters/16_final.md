...
開店披露の日です。最後の仕事は、[TS 教材](../../typescript-fable-101/chapters/16_final.md)・
[React 教材](../../react-fable-101/chapters/16_final.md)と同じく **「壊れていないことを
数秒で確認できる」** 状態を作ること。
...
| 層 | 何を検証 | 道具 | 学んだ場所 |
|---|---|---|---|
| 純粋ロジック | 関数・スキーマ・reducer | Vitest | [TS 第 16 章](../../typescript-fable-101/chapters/16_final.md) |
| コンポーネント | 表示と操作の対応 | Vitest + Testing Library | [React 第 16 章](../../react-fable-101/chapters/16_final.md) |
...
`getByRole` で探すのは [React 第 16 章の Testing Library と同じ哲学](../../react-fable-101/chapters/16_final.md)
...
1. **データベース** — `data/*.json` を本物の DB へ(第 15 章の演習 3 で痛感したはず)。
   ...
   「実行時の定義から型を導く」思想](../../typescript-fable-101/chapters/14_runtime_validation.md)です)
...
4. **クライアント側のサーバーデータ管理** — 高頻度に更新される画面では
   **TanStack Query** が定番([React 第 14 章の⚙️](../../react-fable-101/chapters/14_data_fetching.md)の続き)
