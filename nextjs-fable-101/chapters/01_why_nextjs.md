...
[react-fable-101](../../react-fable-101/README.md) で作った劇場アプリ(Vite + React)の
...
レンダリング](../../react-fable-101/chapters/10_rendering.md)は「関数を呼んで設計図を得る」
...
> なりました。
>
> [react-fable-101 の overview](../../react-fable-101/language-overview/README.md) で触れた
...
|---|---|---|
| 1F: TypeScript / JS | [typescript-fable-101](../../typescript-fable-101/README.md) | **そのまま全部使う**。interface も async/await も門番(zod)も、サーバー側コードは Node.js の世界そのもの |
| 2F: React | [react-fable-101](../../react-fable-101/README.md) | **そのまま全部使う**。コンポーネント・props・state・hooks の書き方は 1 行も変わらない |
...
**確認してください**: これは [react-fable-101 第 1 章](../../react-fable-101/chapters/01_jsx.md)と
