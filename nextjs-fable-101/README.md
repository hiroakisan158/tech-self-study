...
- Next.js のコンポーネントは **[react-fable-101](../react-fable-101/README.md) で学んだ React
  コンポーネントそのもの** です。書き方は 1 行も変わりません。変わるのは「**どこで**(サーバーか
  ブラウザか)**いつ**(ビルド時かリクエスト時か)実行されるか」だけです
- サーバー側の話はすべて **[typescript-fable-101](../typescript-fable-101/README.md) で学んだ
  Node.js の世界**([イベントループ](../typescript-fable-101/chapters/11_event_loop.md)、
  [async/await](../typescript-fable-101/chapters/12_async_await.md)、
  [門番の検問](../typescript-fable-101/chapters/14_runtime_validation.md))の続きです
...
- **前提**: [typescript-fable-101](../typescript-fable-101/README.md) と
  [react-fable-101](../react-fable-101/README.md) の修了相当。この 2 つを飛ばして Next.js から
